...
class DetailUMKMFragment7 : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.detail_umkm_7, container, false)

        // Menginisialisasi ImageButton
        btn = view.findViewById(R.id.button_wa)
        btn.setOnClickListener {
            val wpurl = "https://wa.me/+6285179758586?text=Halo kak, saya ingin memesan produk Edrusya Snack apakah masih tersedia?"
